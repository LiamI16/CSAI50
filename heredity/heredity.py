...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] == None:
            joint_probability *= PROBS["gene"][genes] * PROBS["trait"][genes][person in have_trait]
            continue
        ...
        for parent in ["mother", "father"]:
            ...
            joint_probability *= probability * PROBS["trait"][genes][person in have_trait]
...
def normalize(probabilities):
    ...
    for person in probabilities:
        ...
        for i in probabilities[person]["trait"]:
            trait_total += probabilities[person]["trait"][i]
        for i in probabilities[person]["trait"]:
            probabilities[person]["trait"][i] /= trait_total
